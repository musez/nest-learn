...
export class CreateArticleDto extends PickType(BaseArticleDto,
  ['title', 'summary', 'type', 'thumbUrl', 'contentUrl', 'mediaUrl', 'weight', 'content', 'publicTime', 'browseCount', 'linkCount', 'collectCount', 'shareCount', 'commentCount', 'status', 'description'],
) {
