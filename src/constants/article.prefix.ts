export class ArticlePrefix {
  ...
  static readonly ARTICLE_BROWSE_COUNT: string = 'article:browse:count';// 浏览数量（sorted set） article:browse:count

  static readonly ARTICLE_LINK: string = 'article:link:';// 点赞用户（set） article:link:${articleId}
  static readonly ARTICLE_LINK_COUNT: string = 'article:link:count';// 点赞数量（sorted set） article:link:count

  static readonly ARTICLE_COLLECT: string = 'article:collect:';// 收藏用户（set） article:collect:${articleId}
  static readonly ARTICLE_COLLECT_COUNT: string = 'article:collect:count';// 收藏数量（sorted set） article:collect:count
  ...
  static readonly ARTICLE_COMMENT_COUNT: string = 'article:comment:count';// 评论数量（sorted set） article:comment:count
}
