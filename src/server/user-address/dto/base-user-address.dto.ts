import { IsDefined, IsOptional, IsNotEmpty, IsString, IsInt, MaxLength, IsUUID, IsMobilePhone, IsEmail, MinLength } from 'class-validator';
import { Transform } from 'class-transformer';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { ArticleConstants, BaseConstants, UserConstants } from '../../../constants/constants';
